...
public class ModuleController {
    ...
    public ResponseEntity<Map<String, Object>> getAllModules() {
        ...
        try {
            List<TbJwModule> modules = moduleService.findAll();
    ...
    public ResponseEntity<Map<String, Object>> getModuleTree() {
        ...
        try {
            List<TbJwModule> modules = moduleService.findAll();
            List<TbJwModule> tree = moduleService.buildTree(modules);
            response.put("success", true);
    ...
    public ResponseEntity<Map<String, Object>> getModuleById(@PathVariable Long id) {
        Map<String, Object> response = new HashMap<>();
        try {
            TbJwModule module = moduleService.findById(id);
            if (module != null) {
                response.put("success", true);
     ...
     */
    @PostMapping("/create")
    public ResponseEntity<Map<String, Object>> createModule(@RequestBody TbJwModule module) {
        Map<String, Object> response = new HashMap<>();
        try {
            // 验证模块数据
            ...
            TbJwModule savedModule = moduleService.saveModule(module);
            response.put("success", true);
    ...
    public ResponseEntity<Map<String, Object>> updateModule(@PathVariable Long id, @RequestBody TbJwModule module) {
        Map<String, Object> response = new HashMap<>();
        try {
            TbJwModule existingModule = moduleService.findById(id);
            ...
            TbJwModule updatedModule = moduleService.saveModule(module);
            response.put("success", true);
    ...
    public ResponseEntity<Map<String, Object>> getChildrenByParentId(@PathVariable Long parentId) {
        Map<String, Object> response = new HashMap<>();
        try {
            List<TbJwModule> children = moduleService.findChildrenByParentId(parentId);
            response.put("success", true);
    ...
    public ResponseEntity<Map<String, Object>> searchModules(@RequestParam String moduleName) {
        Map<String, Object> response = new HashMap<>();
        try {
            List<TbJwModule> modules = moduleService.findByModuleName(moduleName);
            response.put("success", true);
            response.put("data", modules);
    ...
    public ResponseEntity<Map<String, Object>> getModulesByType(@PathVariable Integer moduleType) {
        Map<String, Object> response = new HashMap<>();
        try {
            List<TbJwModule> modules = moduleService.findByModuleType(moduleType);
            response.put("success", true);
            response.put("data", modules);
            response.put("message", "获取模块成功");
            return ResponseEntity.ok(response);
